    ...
    for x in range(img.width):
        for y in range(img.height):
            ...
            if x == 0 and y == 0:
                ...
                b_img_left_down = img.get_pixel(x - 1, y + 1)
                r_avg = (
                                    b_img_left.red + b_img_up.red + b_img_left_up.red + b_img_down.red + b_img_left_down.red + img_p.red) // 6
                b_avg = (
                                    b_img_left.blue + b_img_up.blue + b_img_left_up.blue + b_img_down.blue + b_img_left_down.blue + img_p.blue) // 6
                g_avg = (
                                    b_img_left.green + b_img_up.green + b_img_left_up.green + b_img_down.green + b_img_left_down.green + img_p.green) // 6
                b_img_p.red = r_avg
                b_img_p.blue = b_avg
                b_img_p.green = g_avg
                ...
                b_img_left_down = img.get_pixel(x - 1, y + 1)
                r_avg = (
                                    b_img_right_down.red + b_img_right.red + b_img_right_up.red + b_img_left.red + b_img_up.red + b_img_left_up.red + b_img_down.red + b_img_left_down.red + img_p.red) // 9
                b_avg = (
                                    b_img_right_down.blue + b_img_right.blue + b_img_right_up.blue + b_img_left.blue + b_img_up.blue + b_img_left_up.blue + b_img_down.blue + b_img_left_down.blue + img_p.blue) // 9
                g_avg = (
                                    b_img_right_down.green + b_img_right.green + b_img_right_up.green + b_img_left.green + b_img_up.green + b_img_left_up.green + b_img_down.green + b_img_left_down.green + img_p.green) // 9
                b_img_p.red = r_avg
                b_img_p.blue = b_avg
                b_img_p.green = g_avg
